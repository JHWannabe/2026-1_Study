...
|---|---|---|---|---|
| 1 | 0.7455 | 0.6617 | 0.4097 | 0.1828 |
| 2 | 0.7318 | 0.5374 | 0.2669 | 0.1934 |
| 3 | 0.7500 | 0.5994 | 0.3453 | 0.1836 |
| 4 | 0.7489 | 0.5884 | 0.3495 | 0.1842 |
| 5 | 0.7443 | 0.5187 | 0.3055 | 0.1892 |
| **Mean** | **0.7441** | **0.5811** | **0.3354** | **0.1867** |
| **Std** | **0.0065** | **0.0504** | **0.0477** | **0.0041** |

## Test Set 성능 (Test 20%)

| Accuracy | AUC-ROC | AUPRC | Brier |
|---|---|---|---|
| **0.7527** | **0.6287** | **0.3771** | **0.1819** |
