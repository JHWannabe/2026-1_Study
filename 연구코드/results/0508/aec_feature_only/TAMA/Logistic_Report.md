...
|---|---|---|---|---|
| 1 | 0.7409 | 0.4813 | 0.2675 | 0.1920 |
| 2 | 0.7409 | 0.4255 | 0.2644 | 0.1920 |
| 3 | 0.7364 | 0.4872 | 0.2680 | 0.1941 |
| 4 | 0.7397 | 0.4906 | 0.2648 | 0.1932 |
| 5 | 0.7397 | 0.4317 | 0.2411 | 0.1925 |
| **Mean** | **0.7395** | **0.4633** | **0.2612** | **0.1928** |
| **Std** | **0.0017** | **0.0285** | **0.0102** | **0.0008** |

## Test Set 성능 (Test 20%)

| Accuracy | AUC-ROC | AUPRC | Brier |
|---|---|---|---|
| **0.7382** | **0.5099** | **0.2905** | **0.1933** |
