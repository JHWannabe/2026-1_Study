...
|---|---|---|---|---|
| 1 | 0.7455 | 0.7247 | 0.4607 | 0.1699 |
| 2 | 0.7727 | 0.7276 | 0.5175 | 0.1660 |
| 3 | 0.7182 | 0.6996 | 0.4384 | 0.1795 |
| 4 | 0.7671 | 0.7039 | 0.5003 | 0.1709 |
| 5 | 0.7534 | 0.7592 | 0.4982 | 0.1642 |
| **Mean** | **0.7514** | **0.7230** | **0.4830** | **0.1701** |
| **Std** | **0.0192** | **0.0212** | **0.0290** | **0.0053** |

## Test Set 성능 (Test 20%)

| Accuracy | AUC-ROC | AUPRC | Brier |
|---|---|---|---|
| **0.7636** | **0.7869** | **0.5918** | **0.1535** |
