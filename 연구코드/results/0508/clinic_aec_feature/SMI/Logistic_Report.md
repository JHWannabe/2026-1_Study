...
|---|---|---|---|---|
| 1 | 0.7545 | 0.7040 | 0.4316 | 0.1719 |
| 2 | 0.7364 | 0.6698 | 0.3732 | 0.1834 |
| 3 | 0.7682 | 0.7191 | 0.4508 | 0.1678 |
| 4 | 0.7945 | 0.7764 | 0.5002 | 0.1559 |
| 5 | 0.7580 | 0.7468 | 0.4665 | 0.1630 |
| **Mean** | **0.7623** | **0.7232** | **0.4445** | **0.1684** |
| **Std** | **0.0191** | **0.0364** | **0.0421** | **0.0092** |

## Test Set 성능 (Test 20%)

| Accuracy | AUC-ROC | AUPRC | Brier |
|---|---|---|---|
| **0.7927** | **0.8326** | **0.6333** | **0.1413** |
