...
|---|---|---|---|---|
| 1 | 0.7545 | 0.7263 | 0.5000 | 0.1672 |
| 2 | 0.7273 | 0.6901 | 0.4377 | 0.1766 |
| 3 | 0.7364 | 0.6939 | 0.4826 | 0.1772 |
| 4 | 0.7534 | 0.7079 | 0.4809 | 0.1738 |
| 5 | 0.7808 | 0.7551 | 0.5199 | 0.1624 |
| **Mean** | **0.7505** | **0.7147** | **0.4842** | **0.1715** |
| **Std** | **0.0184** | **0.0239** | **0.0272** | **0.0058** |

## Test Set 성능 (Test 20%)

| Accuracy | AUC-ROC | AUPRC | Brier |
|---|---|---|---|
| **0.7782** | **0.7712** | **0.5808** | **0.1560** |
