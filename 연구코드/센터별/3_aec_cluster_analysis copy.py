...
OUTPUT_DIR = BASE_DIR / "result/0327" / SITE_NAME / "aec_cluster_analysis_copy"
...
def save_analysis_outputs(
    ...
    save_sex_ratio_plot(clustered_df, output_dir=output_dir)
    save_boxplot(
        clustered_df,
        "BMI",
        "BMI Distribution by Cluster",
        "cluster_bmi_boxplot.png",
        output_dir=output_dir,
    )
    save_boxplot(
        clustered_df,
        "TAMA",
        "TAMA Distribution by Cluster",
        "cluster_tama_boxplot.png",
        output_dir=output_dir,
    )
