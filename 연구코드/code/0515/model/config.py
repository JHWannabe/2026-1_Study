...
AEC_SHEET = "meta_aec256"   # AEC 데이터가 있는 시트명 (aec_1 ~ aec_256)
AEC_LEN   = 256              # 시트에서 로드할 AEC 컬럼 수 (항상 256)
...
RESULTS_DIR           = "연구코드/results/0515/model_1"   # M1 Clinic Only
RESULTS_DIR_CROSS     = "연구코드/results/0515/model_2"   # M2 Clinic+AEC (Matched)
RESULTS_DIR_CROSS_2_2 = "연구코드/results/0515/model_2_2" # M2_2 Clinic+AEC (Unmatched)
RESULTS_DIR_CROSS3    = "연구코드/results/0515/model_3"   # M3 Clinic+Scanner+AEC
