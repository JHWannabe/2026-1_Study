...
MODEL_DIR = Path(__file__).resolve().parent / "outputs" / "0701" / "aec_new_region_cnn_surrogate_mimic_gate"
OUT_DIR = Path(__file__).resolve().parent / "outputs" / "0701" / "aec_final_gate_subgroup_audit"
OPS = ["S80", "S85", "S90"]
