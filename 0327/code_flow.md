...
CFG 설정 load -> discover_default_paths / parse_args -> AEC Cureve 추출 단계 extract_aec (extract_blue_curve_mask -> detect_plot_bounds -> mask_to_raw_aec -> smooth_1d) -> extract_summary_features -> load_filtered_dataeet -> 그룹별 시각화/통계 저장
