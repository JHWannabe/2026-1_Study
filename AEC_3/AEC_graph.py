...
def extract_non_cor_ct_series(
    ...
    for fp in files:
        ...
        # ✅ 제외 키워드 리스트
        exclude_keywords = ["cor", "sag", "mip", "spo", "mpr"]

        # ✅ 하나라도 포함되면 skip
        if any(k in series_desc_norm for k in exclude_keywords):
            continue
...
if __name__ == "__main__":
    type = "신촌"
    root_dir = rf"D:\데이터서비스팀 영상제공\{type}\{type}_원본"
    out_dir = rf"D:\데이터서비스팀 영상제공\{type}\{type}_AEC_minmax"
